...
FEMongo.prototype.select = function(col, options, callback) {
	var cursor = this.co(col).find(options.where, options.fields, options.options);
	callback(cursor);
	return cursor;
}

FEMongo.prototype.insert = function(col, options, callback) {
	var mn = this;
...
FEMongo.prototype.update = function(col, options, callback) {
	var mn = this;
...
FEMongo.prototype.delete = function(col, options, callback) {
	var mn = this;
